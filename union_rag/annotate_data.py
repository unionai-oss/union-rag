...
def append_annotated_data(
    feedback: str, master_annotation_dataset: FlyteFile
) -> FlyteFile:
...
def create_annotation_set(
    ...
    annotation_set_name: str = DEFAULT_ANNOTATION_SET_NAME,
    master_annotation_dataset: FlyteFile = AnnotatedDataset.query(
        name=Inputs.annotation_set_name
    ),
) -> Annotated[FlyteFile, AnnotatedDataset(name=Inputs.annotation_set_name)]:
    ...
    annotated_dataset = append_annotated_data(
        feedback=feedback, master_annotation_dataset=master_annotation_dataset
    )
