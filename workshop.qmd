...
Follow these steps to use the OpenAI API:

1. [Create an account](https://platform.openai.com/signup) or [login](https://platform.openai.com/login)
2. Create an OpenAI API key here: https://platform.openai.com/api-keys.
3. Add credits if you have no balance: https://platform.openai.com/settings/organization/billing/overview.
   Adding ~$5-10 should be more than enough for this workshop.
